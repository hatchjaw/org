...
GPUs [cite:@bellochPerformance2021] and microcontrollers
[cite:@rushtonNetworked2024] to DIY ambisonics domes
[cite:@mitterhuberOttosonics2022] and frugal wave field synthesis
arrays [cite:@michonMaking2023], efforts are underway to offer
alternatives to the established order, bringing potential benefits, in
terms of cost and scalability, with them. More than mere
...
well-established [cite:@aoesuthsanth]; if, however, the auditory
aspect of virtual and extended reality remains comparatively neglected
when considered alongside other sensory channels
[cite:@serafinReflections2020], this may be ascribed, in part at
least, to the complexity of, and expense associated with, [creating
...
proprietary systems, costly hardware, specialist software and [etc.]
[cite:@rushtonNetworked2024]. Particularly in the case of virtual
acoustics [not really...], in which one may wish for numerous
...
#+caption: Selected embedded computing platforms.
#+attr_latex: :float multicolumn :align lllllr
| Platform         | Processor        | Memory      | Ethernet | PTP | Cost |
|------------------+------------------+-------------+----------+-----+------|
