...
#+caption: computed independently (or two at a time as pictured), in
#+caption: distributed fashion. The integrity of the synthesised wavefront
#+caption: is contigent on synchronicity amongst the group of distributed
#+caption: processors.
