...
We opted not to use Audio Video Bridging (AVB) or AES67 due to the
high complexity associated with implementing these protocols in a
...
modules remain synchronised to within \qty{200}{\nano\second} at all
times.
