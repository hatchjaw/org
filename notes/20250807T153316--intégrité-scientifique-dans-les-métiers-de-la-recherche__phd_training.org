...
- The purpose of OFIS, unlike the US equivalent (ORI) which is
  primarily concerned with fraud, is to prevent, as far as possible,
  the occurrence of fraud. Pre-emptive, preventative, like.
