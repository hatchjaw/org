...
to the two switches; sure enough, ~400 ns offset. I don't think
there's a sensible workaround. Perhaps playing with that daft /hardware
offset/ value in =ptp-base.cpp=...
#+begin_src c++
