...
- If someone wants to put together a distributed spatial audio system
  for spatial audio rendering, now they can do it and it works.
- I'm not going to be able to deliver by Friday: perceptual evaluation.
  + VR community is going to want something like this.
  ...
  + Don't talk about perceptual stuff.
