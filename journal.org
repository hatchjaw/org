...
***** What's next?
****** TODO Submit Inria /demande de cumul/ form
...
****** TODO Mention pattern matching in intro
****** TODO Be more positive in the intro
****** TODO §2.2 mention ~environment~ and parameter enumeration
****** TODO Add signal labels to figure 2
****** TODO Add clarifying parenthesis to equations (23) and (38)
****** TODO Clarify that \(J_{f} = \nabla{}f(\mathbf{s})\)
****** TODO §4.1.3, speak specifically of /unapplied lambda abstractions/
****** TODO A better description of pattern matching
...
****** TODO Expand on caption of listing 3
...
****** TODO Add a word in the intro about being able to compute higher-order derivatives
***** Me
****** TODO Check dimensions of Jacobians
...
as to?
****** TODO Fix discrepancies in title capitalisation
****** TODO Fix URL appearance in footnote 3
****** TODO §4.1.3 mention that unapplied lambdas aren't widely used
****** TODO Future work to be expanded (space allowing)
****** TODO Revisit references for uniformity
...
****** TODO Break long sentence into two
"The risks of buying into a closed, centralised system..."
...
:END:
****** TODO "they can [be] computed in distributed fashion"
****** TODO Maybe specify dates for prices in table 1
...
§5. Mention multicast and DAW/laptop-based control system.
