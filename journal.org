...
*** 2024-04-16 mardi
**** UNREAD SMC24: (16) Artifical Intelligent and Home Music Listening: An Overview and Future Directions :ML:SMC:REVIEW:
***** Summary
***** Notes
...
**** READ SMC24: (126) Real-time Phychoacoustic Frequency Masking Compensation for Audio Signals with Overlaping Spectra :SMC:REVIEW:
***** Summary
Authors describe a VST plugin for psychoacoustic frequency masking
compensation.
***** Notes
- Shouldn't it be called /TheUnmasker/?
- Source code not available. No Linux build. No audio/video examples.
***** Proofreading
  
Entered on [2024-04-17 mer. 11:13]
**** UNREAD SMC24: (70) Three-Dimensional VBAP and Ambisonics in Spat: Implementation and Perceptual Evaluation in a Concerte Setting :SMC:REVIEW:
***** Summary
***** Notes
