...
**** CCRMA Application                                             :VISIT:
No word from Jonathan Abel re. CAVIAR, but Chris Chafe agreed to
sponsor my /Visiting Student Researcher/ application.

OK... lots to do here.

CCRMA [[https://ccrma.stanford.edu/academics/visiting-student-researcher][requirements]]:

- Decide when I want to go. Line it up with one of the 2025-26
  /quarters/. [[https://studentservices.stanford.edu/calendar/academic-dates/future-academic-calendars][Here]] are the dates, but I guess either Winter (Jan 5th —
  March 20th) or Spring (March 30th — June 10th). Leave a few days
  either side.
  + [[https://en.wikipedia.org/wiki/Stanford,_California#Climate][Weather]] wouldn't be /terrible/ Jan-Mar, but, as Romain said,
    better conditions for being outdoors Mar-Jun.
- Write a letter to Netty, with the dates, and a summary of the work I
  want to do. "This is your opportunity to explain why conducting your
  research is mutually beneficial for both you and for CCRMA."
- Visiting Student Researcher form. The link on the requirements page
  is broken.
- Biographic pages of my passport.
- SEVIS DS2019 [[http://ccrma.stanford.edu/info/3.%20SEVIS_DS2019_request.pdf][Form]].

France-Stanford application portal is [[https://stanfordglobalstudies.slideroom.com/][here]]. Requirements ([[https://francestanford.stanford.edu/sites/francestanford/files/media/file/visiting_student_researcher_fellowship_guidelines_2025-26.pdf][pdf]]):

- A letter to France-Stanford's director, describing my research
  project and plans. This letter should identify Chris as my
  sponsor. Indicate the length of my visit. 1-2 pages.
- Letter of endorsement from my sponsor. Chris asked me to draft
  this. 1-2 pages.
- CV.
- "Unofficial academic transcript".
- Budget requested. Ten grand?
- "Budget details", 1 page.

Assuming all goes well, I'll need a [[https://travel.state.gov/content/travel/en/us-visas/study/exchange.html][J-1 visa]].
