...
The above really seems to do the job; for now I'll stick to doing it
manually, but at some point I should incorporate this advice into the
(as-yet nonexistent) documentation for the system.
