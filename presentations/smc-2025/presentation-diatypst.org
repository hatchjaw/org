...
Each can be configured to run at a preferred sampling rate.
...
#+typst: #text(size: 1.5em)[
1 ppm \to \pm1 \micro{}s per second \to \pm1 second every million seconds
...
#+typst: #text(size: 1.5em)[
20 ppm \to \pm1 second every \~14 hours

20 ppm \to \pm20 \micro{}s per second
