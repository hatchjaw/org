...
#+property: header-args:typst :tangle out/theme-diatypst.typ
...
\tikzset{
  pics/teensythinks/.style={
    code={
      ...
      \node [cloud, cloud ignores aspect, cloud puffs=9, cloud puff arc=96, draw, line width=5mm, fill=white] () at (-9, 23) {\nomFS kHz!};
...
#+header: :imagemagick t :iminoptions -density 72 :imoutoptions -geometry 400 -flatten :fit t
...
#+header: :imagemagick t :iminoptions -density 72 :imoutoptions -geometry 1000 -flatten :fit t
#+header: :headers '("\\usepackage{smc25figs}")
#+begin_src latex :eval no-export
\begin{tikzpicture}
  \pic at (0, 0) {teensythinks={nominalfs=48}};
...
#+begin_src latex :eval no-export
\begin{tikzpicture}
  \pic at (0, 0) {teensythinks={nominalfs=48, actualfs=47.98}};
  \pic at (50, 0) {teensythinks={nominalfs=48, actualfs=48.01}};
  \pic at (100, 0) {teensythinks={nominalfs=48, actualfs=47.99}};
\end{tikzpicture}
#+end_src
#+attr_typst: :height 5cm
#+RESULTS:
