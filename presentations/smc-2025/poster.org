...
\begin{equation*}
\frac{44\,100}{128} = 344.531\,25\;, \quad\quad
\frac{48\,000}{128} = 375
\end{equation*}
...
#+begin_src julia :results none :exports none
...
function plotDrift(dataCategory)
    ...
    if dataCategory == "noptp"
        ...
        plot!(title="Raw drift − order of 7 ppm")
    else
        plot!(title="Conditioned clocks − order of 2 ppb")
    end
...
#+begin_src julia :results file graphics :file noptp.png :output-dir ./images/gen :exports results
plotDrift("noptp")
#+end_src
#+attr_org: :width 400
...
#+begin_src julia :results file graphics :file ptp.png :output-dir ./images/gen :exports results
plotDrift("ptp")
#+end_src
#+attr_org: :width 400
#+attr_latex: :width \linewidth
...
[1] J. Schleusner et al., ‘Sub-Microsecond Time Synchronization for Network-Connected Microcontrollers’, in /2024 IEEE International Conference on Consumer Electronics/

[2] A. Carôt, et al., ‘GNSS-based Sound Card
Synchronization’, in /Proceedings of the 2019 Federated Conference on
