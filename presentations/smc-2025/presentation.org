...
#+header: :imagemagick t :iminoptions -density 600 :imoutoptions -geometry 1000 -flatten :fit t
...
# Assuming \(c = \qty{343}{\m\per\s}\), in one millisecond,
# a wavefront propagates the same number of millimetres.
