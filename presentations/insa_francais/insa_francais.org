...
#+REVEAL_TITLE_SLIDE: <h1>%t</h1><h2>%s</h2><h3>%a</h3><div class="logos">
#+REVEAL_TITLE_SLIDE: <img src="images/insa.svg" height="100">
#+REVEAL_TITLE_SLIDE: <img src="images/inria.svg" height="100">
#+REVEAL_TITLE_SLIDE: <img src="images/citi.png" height="100"></div>
#+REVEAL_TITLE_SLIDE_BACKGROUND: #fff
...
** Corriger la couleur des rubriques sur les diapositives de titre
...
** Ameliorer de la mise en page des images de la diapositive de titre principale
...
- Licence en technologie musicale, Université d'Édimbourg, 2009 🏴󠁧󠁢󠁳󠁣󠁴󠁿
- Travail
  #+ATTR_REVEAL: :frag (appear)
  + Musicien, technicien 🎸
  + Programmeur informatique 🖥️
  + Développeur d'applications web 🌐
- MSc informatique du son et de la musique, Université d'Aalborg
  (Copenhague) 2023 🇩🇰
  #+ATTR_REVEAL: :frag (appear)
  + Stage, Inria/Emeraude, Villeurbanne, 2022 🔊
- Actuellement : doctorant, INSA Lyon/Inria/Emeraude
  + Sujet de thèse : « Spatialisation du son sur systèmes distribués »

* Son spatial
:PROPERTIES:
:reveal_background: #282828
