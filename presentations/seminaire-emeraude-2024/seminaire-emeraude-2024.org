...
Then navigate to [[localhost:8000/seminaire-emeraude-2024/]].
...
#+begin_quote
In a distributed audio system, cooperating entities must be served
with the audio and/or control data that they need in order to perform
their part of a signal processing task.
#+end_quote
